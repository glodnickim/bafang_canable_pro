...
function buildPreset(state, name) {
    ...
    return {
        ...
        name: name || '', note: '',
        source: { controller_sw_version: null, bank_schema_version: 6 },
        banks,
...
const descriptors = [
    ...
    { key: 'start_load_reduction_mv', label: 'Pedal load reduction', min: 0, max: 100 },
...
const hostile = {
    ...
    start_load_reduction_mv: 40, // legal, must pass through untouched
...
check(target.start_load_reduction_mv === 40, 'a legal value must pass through unchanged');
