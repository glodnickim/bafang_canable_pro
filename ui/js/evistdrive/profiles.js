    ...
    return gated([
        ...
        // of its values together — a duration copied without its trigger load is meaningless.
        {
            ...
            note: 'Keeps the motor pulling for a moment AFTER you stop pedalling, for lifting '
                ...
                + 'STANDING STILL. Any of these ends it instantly: braking, PEDALLING '
                + 'BACKWARDS, starting to pedal again, changing the assist level, going to '
                + 'level 0, the bike coming to a stop, overheating, a torque or pedal sensor '
                + 'fault, Walk Assist, a calibration, or saving a profile — as well as the '
                + 'timer running out. Pedalling again hands back to normal assist smoothly, '
                + 'without a jolt. An arming that is not used within about 1.5 seconds expires. '
                + 'In legal mode the boost follows your '
